...
Widget buildArticleItem(Map article, context, index) => InkWell(
      onTap: () {
        ...
        // navigateTo(
        //   context,
        //   // HtmlElementView(viewType: article['url']),
        //   WebViewRequest(uri: article['url'], method: WebViewRequestMethod.post),
        // );
      },
      child: Container(
        color: index == NewsCubit.get(context).selectedBusinessItem && NewsCubit.get(context).isDesktop ? Theme.of(context).colorScheme.secondary : null,
        child: Padding(
...
Future navigateTo(context, nextScreen) => Navigator.push(
